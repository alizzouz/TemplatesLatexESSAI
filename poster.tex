...
\VeryHuge \color{NavyBlue} \textbf{ the fate of passengers on ‘Titanic’} \color{Black}\\[0.5cm]% Title
...
\begin{minipage}[b]{0.75\linewidth}
\huge \textbf{Ali Azzouz}\\[0.5cm] % Author(s)
...
\large \texttt{ aliazzzouz90@gmail.com} --- +216 54192736\\
\end{minipage}
